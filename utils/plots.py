...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=2048, max_subplots=16):
    ...
    mosaic = np.full((int(ns * h), int(ns * w), channel), 255, dtype=np.uint8)  # init
